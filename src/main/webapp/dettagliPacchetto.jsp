                ...
                <%}else{%>
                    <div class="Prezzo2">
                        <form class="form" action="AdminControl?action=ModificaPacchetto&id=<%=pacchetto.getCodSeriale()%>" method="post" name="modificaInformazioni" onsubmit="return validate()">
                            ...
                            <div class="afd">
                                <button class="button3" type="submit">Aggiorna!</button>
                                <button type="button" class="button" onclick="location.href='AdminControl?action=RimuoviPacchetto&id=<%=pacchetto.getCodSeriale()%>'">
                                    <svg
